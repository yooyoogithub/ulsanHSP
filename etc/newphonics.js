...
function Getunits() {
  ...
  bookselected = document.getElementById('book').value;
  //unitselected 배열 초기화
  ...
  document.getElementsByClassName("article2").innerHTML = '<img id="images" src = "HSPC.PNG" width="100%" height="100%">';
...
function wordstudy_1() {
  ...
  if (wordstudycount < selecteditem.length) {
    main.innerHTML = '<img src="' + bookselected + '/' + selecteditem[wordstudycount][1] + '" width="50%" height="50%">';
    myaudio.src = bookselected + '/' + selecteditem[wordstudycount][2];
...
function StopStudy() {
  ...
  sbutton.innerHTML = '<input class="realbutton" type="button" id="startstudy" value="학습시작" onclick="StartStudy()">';
  lineup.innerHTML = "<div>이제 " + bookselected + "의 유닛 " + unitselected + "의 학습이 끝났습니다.</div>";
  mainscreen.innerHTML = '<img src="HSPC.PNG" width="100%" height="100%">';
...
function wordplay_1in() {
  ...
  sbutton.innerHTML = '<input class="realbutton" type="button" id="startstudy" value="다음학습" onclick="wordplay_2in()">';
  ...
  for (let i = 1; i < selecteditem.length; i++) {
    if (selecteditem[i][4] == 'w') {
      playunitinfo.push([document.getElementById('book').value, selecteditem[i][0], selecteditem[i][1], selecteditem[i][2], selecteditem[i][3], selecteditem[i][4], selecteditem[i][5], selecteditem[i][6], selecteditem[i][7], selecteditem[i][8]]);
    }
  }
...
function wordplay_1() {
  ...
  centerquestionimage = '<div style="display:flex;flex-direction:column;align-items:center;gap:20px;">'
    + '<div style="display:grid;grid-template-columns:repeat(2, 1fr);gap:20px;width:fit-content;">'
    + '<span class="questionimage"><img src="' + q1 + '" width="300px" height="285px" onclick="imageclick(1)"></span>'
    + '<span class="questionimage"><img src="' + q2 + '" width="300px" height="285px" onclick="imageclick(2)"></span>'
    + '<span class="questionimage"><img src="' + q3 + '" width="300px" height="285px" onclick="imageclick(3)"></span>'
    + '<span class="questionimage"><img src="' + q4 + '" width="300px" height="285px" onclick="imageclick(4)"></span>'
    + '</div>'
    + '<div style="text-align:center;"><input class="justbutton" type="button" style="height:40px;" value="준비되면 누르세요." onclick="playquestion()"></div>'
    + '</div>';
...
function wordplay_2() {
  ...
  centerquestionimage = '<div style="display:flex;flex-direction:column;align-items:center;gap:20px;">'
    + '<div style="display:grid;grid-template-columns:220px 220px;grid-template-rows:80px 80px;gap:20px;">'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_2_answerclick(1)">' + q1 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_2_answerclick(2)">' + q2 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_2_answerclick(3)">' + q3 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_2_answerclick(4)">' + q4 + '</button></div>'
    + '</div>'
    + '<div style="text-align:center;"><input class="justbutton" type="button" style="height:40px;" value="준비되면 누르세요." onclick="playquestion()"></div>'
    + '</div>';
...
function wordplay_3in() {
  ...
  sbutton.innerHTML = '<input class="realbutton" type="button" id="startstudy" value="다음학습" onclick="wordplay_4in()">';
...
function wordplay_3() {
  ...
  //wordplay_2_answerclick(answer)
  centerquestionimage = '<div style="display:flex;flex-direction:column;align-items:center;gap:20px;">'
    + '<div style="font-size:40px;text-align:center;">' + tempplayui[randanswernum][7] + '</div>'
    + '<div style="display:grid;grid-template-columns:220px 220px;grid-template-rows:80px 80px;gap:20px;">'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_3_answerclick(1)">' + q1 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_3_answerclick(2)">' + q2 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_3_answerclick(3)">' + q3 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_3_answerclick(4)">' + q4 + '</button></div>'
    + '</div>'
    + '<div style="text-align:center;"><input class="justbutton" type="button" style="height:40px;" value="준비되면 누르세요." onclick="playquestion()"></div>'
    + '</div>';
...
function wordplay_4() {
  ...
  //wordplay_2_answerclick(answer)
  centerquestionimage = '<div style="display:flex;flex-direction:column;align-items:center;gap:20px;">'
    + '<div style="font-size:40px;text-align:center;">' + qkorean + '</div>'
    + '<div style="display:grid;grid-template-columns:220px 220px;grid-template-rows:80px 80px;gap:20px;">'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_4_answerclick(1)">' + q1 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_4_answerclick(2)">' + q2 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_4_answerclick(3)">' + q3 + '</button></div>'
    + '<div><button class="qbutton" style="margin:0 !important;width:220px !important;height:80px !important;" onclick="wordplay_4_answerclick(4)">' + q4 + '</button></div>'
    + '</div>'
    + '<div style="text-align:center;"><input class="justbutton" type="button" style="height:40px;" value="준비되면 누르세요." onclick="playquestion()"></div>'
    + '</div>';
...
function wordplay_5in() {
  ...
  mainscreen.innerHTML = '<img src="HSPC.PNG" width="50%" height="50%">';
  linedown.innerHTML = '<div>다시 학습할려면 학습하기를 누르세요.</div>';
  sbutton.innerHTML = '<input class="realbutton" type="button" id="startstudy" value="학습하기" onclick="StartStudy()">';
